...
export KOS_LIBS="-Wl,--start-group -lgnustep-base -lkosutils -lkallisti -lobjc -lm -lc -lgcc -Wl,--end-group"
...
export KOS_OBJCFLAGS="${KOS_OBJCFLAGS} -lkosutils -fgnu-runtime"
